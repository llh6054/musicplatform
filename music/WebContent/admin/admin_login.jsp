...
<script type="text/javascript">
	...
	function login() {
		...
		if(password == ""){
			...
			$.post('<%=request.getContextPath()%>/home/admin_login', {'userName':userName, 'password':password, 'action':"action"}, function(data) {
				//alert(data);
				if(data == 1)
					window.parent.location.href = "<%=request.getContextPath()%>/home/admin";
				else
